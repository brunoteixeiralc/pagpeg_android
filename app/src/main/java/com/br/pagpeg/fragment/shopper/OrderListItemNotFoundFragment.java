...
public class OrderListItemNotFoundFragment extends Fragment {
    ...
    public List<ProductCart> productCartsAll;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mLayoutManager = new LinearLayoutManager(OrderListItemNotFoundFragment.this.getActivity());
        mAdapter = new OrderListAdapter(onClickListener(),OrderListItemNotFoundFragment.this.getContext(),productCartsAll);
        recyclerView = (RecyclerView) view.findViewById(R.id.recyclerView);
        recyclerView.setLayoutManager(mLayoutManager);
        recyclerView.setItemAnimator(new DefaultItemAnimator());
        recyclerView.setHasFixedSize(true);
        recyclerView.setAdapter(mAdapter);
        recyclerView.addItemDecoration(new DividerItemDecoration(OrderListItemNotFoundFragment.this.getContext(),LinearLayoutManager.VERTICAL));
    ...
    private OrderListAdapter.OrderListOnClickListener onClickListener() {
        return new OrderListAdapter.OrderListOnClickListener() {
            ...
            public void onClickItem(View view, int idx) {
                ...
                IntentIntegrator.forSupportFragment(OrderListItemNotFoundFragment.this).setCaptureActivity(BarCodeActivity.class).initiateScan();
            }
            ...
            if (result != null) {
                ...
                if (result.getContents() != null) {
                    ...
                    if (String.valueOf(productCartSelect.getProduct().getBar_code()).equalsIgnoreCase(result.getContents())) {
                        ...
                        Intent intent = new Intent(OrderListItemNotFoundFragment.this.getActivity(), ProductDetailActivity.class);
